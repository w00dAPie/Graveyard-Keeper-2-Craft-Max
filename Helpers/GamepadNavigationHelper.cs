...
namespace GK2CraftMax.Helpers
{
    ...
    {
        internal static GamepadNavigationController
            GetController(object window)
        {
            if (window == null)
                return null;

            return Traverse.Create(window)
                .Property(
        ...
        internal static List<GamepadNavigationItem>
            GetItems(
            ...
            GamepadNavigationItem to)
        {
            ...
            from.SetCustomDirectionItem(
                direction,
                to
            );
        }

        internal static void BindButtonPress(
